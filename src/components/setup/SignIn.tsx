...
const usePlexAuth = () => {
  ...
  const clientInfo: IPlexClientDetails = {
    ...
    forwardUrl: `${process.env.NEXT_PUBLIC_URL_PROTOCOL}://${process.env.NEXT_PUBLIC_VERCEL_URL}/setup?postback=true`, // Optional - Url to forward back to after signing in.
